...
})({"jgoWi":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "5e7c5292a758b7aa";
"use strict";
...
},{}],"vBPkk":[function(require,module,exports) {
...
var _productModalAddToCart = require("./functions/productModalAddToCart");
...
window.onload = ()=>{
    ...
    _productModalAddToCart.productModalAddToCart();
...
},{"./functions/activateHamburgerMenu":"4wXe7","./functions/createProductsCheckout":"j4N9p","./functions/productModalAddToCart":"dVurV","./functions/productsDisplay":"52hqZ","./functions/wishListDisplays":"6rkmj"}],"4wXe7":[function(require,module,exports) {
...
},{}],"j4N9p":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"dVurV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "productModalAddToCart", ()=>productModalAddToCart
);
var _products = require("../models/products");
var _createProductsCheckout = require("../functions/createProductsCheckout");
function productModalAddToCart() {
    //#region Declarations
    let titleIdentifier = document.getElementById("modalTitle");
    let addButton = document.getElementById("addProduct");
    let amountOfProducts = document.getElementById("productModalAmount");
    let modalContainer = document.getElementById("modalContainer");
    let size = document.getElementById("productModalSize");
    //#endregion
    addButton.addEventListener("click", (e)=>{
        ...
        let incomingProduct;
        let productName = titleIdentifier.innerHTML;
        _products.products.forEach((product)=>{
            productName == product.name && (incomingProduct = product);
        });
        //Creates a new product based on the incomingProdcut(Iproduct), the size and amount values that the user put in.
        let newProduct = new _products.StorageProduct(incomingProduct, size.value, parseInt(amountOfProducts.value));
        ...
        let localStorageArray = JSON.parse(cartList);
        ...
        localStorageArray.forEach((storageItem, storageItemIndex)=>{
            if (JSON.stringify(storageItem.Iproduct) === JSON.stringify(newProduct.Iproduct) && storageItem.size.toString() === newProduct.size.toString()) matchIndex = storageItemIndex;
        });
        ...
        if (matchIndex >= 0) localStorageArray[matchIndex].amount += parseInt(amountOfProducts.value);
        else localStorageArray.push(newProduct);
        let localStorageArrayStringify = JSON.stringify(localStorageArray);
...
},{"../models/products":"acInb","../functions/createProductsCheckout":"j4N9p","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"acInb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../functions/productsDisplay":"52hqZ","./wishListDisplays":"6rkmj","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"6rkmj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../models/products":"acInb","./productsDisplay":"52hqZ","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"9Z6QU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../models/products":"acInb","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["jgoWi","vBPkk"], "vBPkk", "parcelRequire5db4")

//# sourceMappingURL=products.a758b7aa.js.map
